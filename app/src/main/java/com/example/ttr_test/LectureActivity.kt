...
import com.example.ttr_test.Fragment.FragmentAdapter
...
class LectureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list_viewpager.addOnPageChangeListener(TabLayout.TabLayoutOnPageChangeListener(tab_layout))//when move page change tab

        tab_layout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener{//when click tab move page
